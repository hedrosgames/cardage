...
using UnityEngine;
[CreateAssetMenu(menuName="Game/Rules/CardEffects/RuleBonus1")]
public class RuleBonus1 : SOCapture
{
    public int GetBonus(SOCardData card, CardSlot slot, ManagerBoard board, int ownerId, bool isAttacking, List<CardSlot> capturedThisTurn)
    {
        if (SlotBonusManager.Instance != null)
        {
            ...
            if (slotBonus == CardGeneralRule.Bonus1)
            return 1;
        }
        return 0;
    }
    public override void OnMatchStart()
    {
        ...
        {
            SlotBonusManager.Instance.InitializeSlotBonuses(board, CardGeneralRule.Bonus1);
        }
    }
