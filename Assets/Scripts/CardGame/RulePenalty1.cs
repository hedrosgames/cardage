...
using UnityEngine;
[CreateAssetMenu(menuName="Game/Rules/CardEffects/RulePenalty1")]
public class RulePenalty1 : SOCapture
{
    public int GetBonus(SOCardData card, CardSlot slot, ManagerBoard board, int ownerId, bool isAttacking, List<CardSlot> capturedThisTurn)
    {
        if (SlotBonusManager.Instance != null)
        {
            ...
            if (slotBonus == CardGeneralRule.Penalty1)
            return -1;
        }
        return 0;
    }
    public override void OnMatchStart()
    {
        ...
        {
            SlotBonusManager.Instance.InitializeSlotBonuses(board, CardGeneralRule.Penalty1);
        }
    }
