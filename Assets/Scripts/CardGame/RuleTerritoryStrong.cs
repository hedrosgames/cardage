...
using UnityEngine;
[CreateAssetMenu(menuName="Game/Rules/CardEffects/RuleTerritoryStrong")]
public class RuleTerritoryStrong : SOCapture
{
    ...
    {
        return HasClanCardAdjacent(slot, board, card.type, ownerId) ? 2 : 0;
    }
